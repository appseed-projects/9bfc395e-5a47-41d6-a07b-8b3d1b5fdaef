...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-10-28 12:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9bfc395e-5a47-41d6-a07b-8b3d1b5fdaef.git
$ cd 9bfc395e-5a47-41d6-a07b-8b3d1b5fdaef
```
